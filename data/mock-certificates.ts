...
export const MockCertificates = reactive<Certificates[]>([
    {
			"id": "UC-9429735b-c612-4387-88e2-92cfe0b6878d",
    ...
    {
	    "id": "introducao-a-programacao-com-ruby-e-jogos-1",
    ...
    {
			"id": "introducao-a-programacao-com-ruby-e-jogos-2",
    ...
    {
	    "id": "introducao-a-programacao-com-ruby-e-jogos-3",
    ...
    {
	    "id": "ruby-on-rails-5-validacao-atualizacao-partials-deploy",
    ...
    {
	    "id": "go-validacoes-testes-paginas-html",
    ...
    {
	    "id": "android-kotlin-persistencia-dados-room",
    ...
    {
	    "id": "android-kotlin-personalize-app",
    ...
    {
	    "id": "android-kotlin-migrations-relacionamento-room",
    ...
    {
	    "id": "kotlin-heranca-polimorfismo-interface",
    ...
    {
	    "id": "kotlin-recursos-da-linguagem-com-pacotes-e-composicao",
    ...
    {
	    "id": "kotlin-exceptions-null-safety",
    ...
    {
	    "id": "kotlin-introducao-collections-arrays-listas",
    ...
    {
	    "id": "kotlin-recursos-do-paradigma-funcional",
    ...
    {
      "id": "UC-87bd7a34-7c0e-47a4-91fc-c8583628fe42",
    ...
    {
      "id": "UC-9ad3b702-32f2-4e9f-a1a1-55b05dba5596",
    ...
    {
      "id": "UC-277a8a2d-a235-48aa-8ff3-6b14692b4ad0",
    ...
    {
      "id": "UC-c6480bed-681d-4998-aeb6-4eb0048870d4",
    ...
    {
      "id": "UC-bb81955d-6f98-4fbc-9b5d-3602bc849d0d",
    ...
    {
      "id": "UC-50a90aec-6e77-48d4-9e13-f263c8014798",
    ...
    {
      "id": "UC-89e500c7-7a6c-4f76-8922-9df58fcfc3aa",
    ...
    {
      "id": "1QUKAcKbgH8OeyeVm6LdGp1WXj8FB263e",
    ...
    {
      "id": "12GSDLJHYbYuTUg2T_wFHm7ooKdIHwwHR",
    ...
    {
      "id": "1bDJHnbezaj7JVvH_FoABUUBnCNftrIsE",
    ...
    {
      "id": "10gM-_DNJdcjp5XaB64COdVrBQVqkHA2E",
    ...
    {
      "id": "UC-35c234e5-a20c-4466-9dbd-89339cdaf912",
    ...
    {
      "id": "UC-faef641d-c803-4b98-805d-beb2600fda05",
    ...
    {
      "id": "UC-84f78411-5168-4925-b7ff-a04f88405105",
    ...
    {
        "id": "UC-a2af6082-8245-413b-beca-53b703a89409",
    ...
    {
        "id": "UC-4468e666-8938-4eac-b1c0-fc37c1a8a214",
    ...
    {
        "id": "UC-275a3c3e-14c0-4e45-bb9c-9566f441ae31",
    ...
    {
        "id": "UC-e29bd996-0660-4e72-9aa1-8d30bd172f05",
    ...
    {
        "id": "UC-90bd55f9-a0a1-4bec-8769-92b666d656df",
    ...
    {
        "id": "UC-cebb3fcd-49a0-4639-943f-6da6c64465cb",
    ...
    {
        "id": "UC-fa269090-f0d8-4041-b545-5cba68d00485",
    ...
    {
        "id": "UC-b8806ee0-75f6-4466-8b48-0fdb03c134bd",
    ...
    {
        "id": "UC-f0f3d505-bb39-423f-bedc-e26aaedf703b",
    ...
    {
        "id": "UC-e7cffdbd-1317-4521-bb4b-fd45f1519dea",
    ...
    {
        "id": "UC-d3269a6c-3b4c-4a06-8225-6e996f7dab5c",
